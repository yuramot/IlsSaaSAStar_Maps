...
begin
  FRedis := NewRedisClient('localhost', 6379, False, 'indy');
end;
...
begin
  ...
  Values := FRedis.HMGET('abc', VarArrayOf(['Name', 'Address', 'Postcode']));
...
begin
  FRedis.DEL([C_KEY]);
  FRedis.HMSET(C_KEY, VarArrayOf(['field1', 'field2', 'field3']),
    VarArrayOf(['value1', 'value2', 'value3']));
  lValues := FRedis.HMGET(C_KEY, VarArrayOf(['field1', 'field2', 'field3']));
