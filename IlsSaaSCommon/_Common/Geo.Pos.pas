...
const
  CEvDegLengthKm = 111.225;   //! среднее значение длины градуса ((меридиан + экватор) / 2), км
  CEvDegLength = 111225.;     //! среднее значение длины градуса ((меридиан + экватор) / 2), м
  CEvEarthRadiusKm = 6371.;   //! средний радиус Земли, км
  CEvEarthRadius = 6371000.;  //! средний радиус Земли, м
  CTolerance = 1E-5;          //! максимально допустимая относительная погрешность при сравнении
  CMpsToKmh = 3.6;
